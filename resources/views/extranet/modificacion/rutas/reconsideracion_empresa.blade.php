...
<div class="page-breadcrumb">
  <div class="row">
    <div class="col-12 d-flex no-block align-items-center">
      <h4 class="page-title">Ruta / Reconsideracion</h4>
      ...
      <div class="card">
        <div class="card-body">
          <form id="formulary">
            ...
            <h6 class="text-success">Rutas Activas</h6>
                    ...
                    <tr>
                      <td>
                        <div class="custom-control custom-checkbox">
                          <input type="checkbox" class="custom-control-input check_ruta" id="ruta{{$key}}" name="rutas[]" value="{{$value->RowId}}">
                          <label class="custom-control-label" for="ruta{{$key}}">Editar</label>
                        </div>
                      </td>
                      <td>
                      	{{$value->Origen}}
            ...
            <hr>
            <h6 class="text-danger">Rutas Renunciadas</h6>
                ...
                <tbody>
                  @foreach($renuncia as $key => $value)
                    ...
                    <tr>
                      <td>
                        <div class="custom-control custom-checkbox">
                          <input type="checkbox" class="custom-control-input check_ruta" id="renuncia{{$key}}" name="renuncia[]" value="{{$value->RowId}}">
                          <label class="custom-control-label" for="renuncia{{$key}}">Editar</label>
                        </div>
                      </td>
                      <td>
                      	<div class="form-group">
...
<script type="text/javascript" src="{{asset('js/extranet/modificacion/rutas/reconsideracion_empresa.js')}}"></script>
@endsection
