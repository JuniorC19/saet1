...
<div class="page-breadcrumb">
  <div class="row">
    <div class="col-12 d-flex no-block align-items-center">
      <h4 class="page-title">Ruta / Frecuencia</h4>
            ...
            <div class="table-responsive">
              <table class="table table-bordered">
                <thead>
                  ...
                  <th class="font-weight-bold">Itinerario</th>
                    ...
                    <tr>
                      ...
                      <td>
                        <div class="from-group">
                          <input type="" class="form-control" name="frecuencia{{$value->RowId}}" value="{{$value->Frecuencia}}" disabled="true"
                            required="true" data-msg-required="Este campo es requerido." 
                          >
                        </div>
                      </td>
                      <td>{{$value->Itinerario}}</td>
...
<script type="text/javascript" src="{{asset('js/extranet/modificacion/rutas/frecuencia_empresa.js')}}"></script>
@endsection
