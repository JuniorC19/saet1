...
<div class="container-fluid">
	<div class="row">
	  <div class="col-lg-12">
	    <div class="card">
	      <div class="card-body">
	        <form id="formulary" method="GET" action="{{url('/extranet/modificacion/rutas/frecuencia/empresa')}}">
...
<script type="text/javascript" src="{{asset('js/extranet/modificacion/rutas/frecuencia.js')}}"></script>
@endsection
