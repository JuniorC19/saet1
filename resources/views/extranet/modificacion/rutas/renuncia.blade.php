...
<div class="page-breadcrumb">
	<div class="row">
		<div class="col-12 d-flex no-block align-items-center">
			<h4 class="page-title">Ruta / Renuncia</h4>
...
<div class="container-fluid">
	<div class="row">
	  <div class="col-lg-12">
	    <div class="card">
	      <div class="card-body">
	        <form id="formulary" method="GET" action="{{url('/extranet/modificacion/rutas/renuncia/empresa/')}}">
...
<script type="text/javascript" src="{{asset('js/extranet/modificacion/rutas/renuncia.js')}}"></script>
@endsection
