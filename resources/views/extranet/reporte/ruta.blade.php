...
<div class="page-breadcrumb">
	<div class="row">
		<div class="col-12 d-flex no-block align-items-center">
			<h4 class="page-title">Reportes / Rutas</h4>
...
<div class="container-fluid">
	<div class="row">
	  <div class="col-lg-12">
	    <div class="card">
	      <div class="card-body">
	        <form id="formulary" method="GET" action="{{url('/extranet/reporte/ruta/empresa/')}}">
...
<script type="text/javascript" src="{{asset('js/extranet/reporte/ruta.js')}}"></script>
@endsection
