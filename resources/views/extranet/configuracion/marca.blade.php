...
<div class="page-breadcrumb">
	<div class="row">
		<div class="col-12 d-flex no-block align-items-center">
			<h4 class="page-title">Configuracion / Marca</h4>
	      ...
	      <div class="card-header bg-white">
	        <div class="row">
	              ...
	              <div class="row">
	                <div class="col-md-4">
	                  <div class="form-group m-0">
	                    <label for="cate">Catergoria</label>
	          ...
	          <div class="col-md-2">
	            ...
	            <button class="btn btn-primary float-right" id="nuevo"><i class="fa fa-plus"></i> Nueva Marca</button>
	          </div>
	        </div>
	      </div>
	      <div class="card-body">
...
<script type="text/javascript" src="{{asset('js/extranet/configuracion/marca.js')}}"></script>
@endsection
