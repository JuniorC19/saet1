...
<div class="page-breadcrumb">
	<div class="row">
		<div class="col-12 d-flex no-block align-items-center">
			<h4 class="page-title">Configuracion / Categoria</h4>
	      ...
	      <div class="card-header bg-white">
	        <div class="row">
	          ...
	          <div class="col-md-2">
	            ...
	            <button class="btn btn-primary float-right" id="nuevo"><i class="fa fa-plus"></i> Nueva Categoria</button>
	          </div>
	        </div>
	      </div>
	      <div class="card-body">
...
<script type="text/javascript" src="{{asset('js/extranet/configuracion/categoria.js')}}"></script>
@endsection
