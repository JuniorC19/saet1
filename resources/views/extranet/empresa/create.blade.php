	      ...
	      <div class="card-body">
	        <form id="formulary">
			        ...
			        <div class="col-lg-3 col-md-4 form-group">
						    <label for="ruc">Ruc <a href="#" id="buscar">Buscar en JNE</a></label>
			    		...
			    		<div class="col-lg-6 col-md-12 form-group">
						    <label for="nombre">Nombre Imprimir</label>
			    	...
			    	<div class="row">
						  ...
						  <div class="col-lg-4 col-md-4 form-group">
						    <label for="ficha">N° Ficha Registro</label>
						    <input type="text" class="form-control" id="ficha" name="ficha">
						  </div>
						  <div class="col-lg-4 col-md-4 form-group">
						    <label for="partida">N° Partida Electronica</label>
						    <input type="text" class="form-control" id="partida" name="partida">
						  </div>
			    	</div>
			    	<hr class="mt-0">
			    	<h6 class="text-primary">Primera Autorizacion</h6>
			    	<div class="row">
						  <div class="col-lg-6 col-md-12 form-group">
...
<script type="text/javascript" src="{{asset('js/extranet/empresa/create.js')}}"></script>
@endsection
