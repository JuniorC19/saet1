...
<div class="page-breadcrumb">
	<div class="row">
		<div class="col-12 d-flex no-block align-items-center">
			<h4 class="page-title">Terminales</h4>
    ...
    <div class="card">
      <div class="card-header bg-white">
        <div class="float-right">
        	<button class="btn btn-primary float-right" id="nuevo"><i class="fa fa-plus"></i> Nueva terminal</button>
        </div>
      </div>
      <div class="card-body">
      ...
      <div class="modal-body">
        <form id="formulary">
          <div class="row">
            ...
            <div class="col-md-12">
              <div class="form-group">
                  <label for="certificado_habilitacion">N° Certificado de Habilitacion</label>
                  <input type="text" id="certificado_habilitacion" name="certificado_habilitacion" class="form-control" aria-required="true">
              </div>
            </div>
          </div>
        </form>
...
<script type="text/javascript" src="{{asset('js/extranet/empresa/terminal.js')}}"></script>
@endsection
