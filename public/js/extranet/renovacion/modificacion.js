$(document).ready(function(){
	$(".check_habilitar").on("click",function(){
    ...
    $(".custom-control-input").on('click',function(){
        ...
        checks = $(td).find(".custom-control-input");
        $(checks).prop("checked",false);
        $(this).prop("checked",true);
    });
    $("#vehiculos").delegate('.custom-control-input','click',function(){
        td = $(this).parent().parent();
        checks = $(td).find(".custom-control-input");
        $(checks).prop("checked",false);
        $(this).prop("checked",true);
        ...
        $.ajax({
            ...
            success:function(data){
                if (data.status==true) {
                    ...
                    $("#clon tr:eq(0)").find(".sustitucion_entra_vehiculo").attr('id',"sustitucion_entra"+e.params.data.id);
                    $("#clon tr:eq(0)").find(".sustitucion_entra_vehiculo").val(e.params.data.id);
                    $("#clon tr:eq(0)").find(".sustitucion_label").attr("for","sustitucion_entra"+e.params.data.id);

                    $("#clon tr:eq(0)").find(".incremento_vehiculo").attr('id',"incremento"+e.params.data.id);
                    $("#clon tr:eq(0)").find(".incremento_vehiculo").val(e.params.data.id);
                    $("#clon tr:eq(0)").find(".imcremento_label").attr("for","incremento"+e.params.data.id);
            ...
            $.ajax({
                ...
                success:function(data){
                    ...
                    if(data.status == true){
                        ...
                        $("#clon tr:eq(0)").find(".sustitucion_entra_vehiculo").attr('id',"sustitucion_entra"+data.id);
                        $("#clon tr:eq(0)").find(".sustitucion_entra_vehiculo").val(data.id);
                        $("#clon tr:eq(0)").find(".sustitucion_label").attr("for","sustitucion_entra"+data.id);

                        $("#clon tr:eq(0)").find(".incremento_vehiculo").attr('id',"incremento"+data.id);
                        $("#clon tr:eq(0)").find(".incremento_vehiculo").val(data.id);
                        $("#clon tr:eq(0)").find(".imcremento_label").attr("for","incremento"+data.id);
