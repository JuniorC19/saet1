$(document).ready(function(){
     ...
     var susti = 0;
     var checks = 0;
     function rev(susti,checks){
     	if(susti<checks){
    		$("#add-vehiculo").show("slow");
    	}else{
    		$("#add-vehiculo").hide("slow");
    	}
     }
    $("#plus-vehiculo-inactivos").on("click",function(){
        $("#vehiculo-inactivos").show("slow");
        $("#remove-vehiculo-inactivos").show("slow");
        $("#plus-vehiculo-inactivos").hide("slow");
    });
    $("#remove-vehiculo-inactivos").on("click",function(){
        $("#vehiculo-inactivos").hide("slow");
        $("#remove-vehiculo-inactivos").hide("slow");
        $("#plus-vehiculo-inactivos").show("slow");
        $(".check_vehiculo_i").prop("checked",false);
        checks = $(".check_vehiculo:checked").length;
        rev(susti,checks);
    });
   ...
   $('#anio').datepicker({
    ...
    $(".check_vehiculo").on("click",function(){
    	checks = $(".check_vehiculo:checked").length;
    	rev(susti,checks);
    })
    $("#vehiculo").select2({
    ...
    $("#guardar").on("click",function(){
    	...
    	if(validar == true){
            ...
            $.ajax({
                type: "POST",
                dataType: "json",
                url: "/extranet/modificacion/vehiculos/sustitucion/save",
                data:data,
                success:function(data){
                    $('.page-wrapper').loader('hide');
                        ...
                        $.confirm({
                            ...
                            buttons: {
                              confirm: {
                                  ...
                                  btnClass: 'btn-green',
                                  action: function(){
                                    $(location).attr('href',"/extranet/modificacion/vehiculos/sustitucion");
                                  }
                              }
                            }
                        });
